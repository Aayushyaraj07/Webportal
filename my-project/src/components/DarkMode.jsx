...
const DarkMode = () => {
    ...
    useEffect(() => {
        ...
        if (theme === "bluee") {
            element.classList.add("bluee")
            element.classList.remove("redd")
            element.classList.remove("yelloow")
        }
        else if (theme === "yelloow") {
            element.classList.add("yelloow")
            element.classList.remove("redd")
            element.classList.remove("bluee")
        }
        else {
            element.classList.add("redd")
            element.classList.remove("yelloow")
            element.classList.remove("bluee")
        }
        console.log(theme)
    ...
    return (
        <div className='relative flex justify-between gap-4'>
            ...
            <div className='flex justify-between gap-1'>
                <div
                    onClick={() => setTheme("redd")}
                    className={`w-4 h-4 mt-3 bg-red-500 cursor-pointer absolute right-[40px] z-10  transition-all duration-300`}
                ></div>
                <div
                    onClick={() => setTheme("yelloow")}
                    className={`w-4 h-4 mt-3 bg-yellow-500  cursor-pointer absolute right-[60px]  z-10  transition-all duration-300`}
                ></div>
                <div
                    onClick={() => setTheme("bluee")}
                    className={`w-4 h-4 mt-3 bg-blue-500  cursor-pointer absolute right-[80px]  z-10  transition-all duration-300`}
                ></div>
            </div>

            <div className='z-10 mr-5 '>
                <div className='menu-container'>
                    <div className='menu-trigger absolute w-20'>
                        <img src="data:image/jpeg;base64,"
                            ...
                            className='object-contain bg-white cursor-pointer border-2 w-[48px] h-[48px] rounded-full overflow-hidden' />

                        {open && (
                            <div ref={menuRef}>
                                <div className="bg-white  origin-center rotate-45 h-3 ml-6 w-3 -mb-3  z-40"></div>
                                <div className=" rounded-xl p-1 w-30 group transition: ease-in-out duration-700">
                                    <ul className="rounded-2xl ">
                                        {Menus.map((data, index) => (
                                            <li key={index} className=''>
                                                <Link
                                                    to={data.link}
                                                    className="inline-block text-l w-24 p-2  bg-white font-semibold text-gray-500 hover:text-primary
